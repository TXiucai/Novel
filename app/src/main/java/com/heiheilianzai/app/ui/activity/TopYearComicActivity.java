...
public class TopYearComicActivity extends BaseTopYearActivity<StroreComicLable> {
    ...
    public void initView() {
        ...
        adapter = new HomeStoreComicAdapter(TopYearComicActivity.this, listData,true);
        super.initView();
    }

    @Override
    protected void getStockData() {
        getStockData("TopYearComicMan", ReaderConfig.mTopYearComicUrl);
    }

    @Override
    protected void getCacheStockData() {
        getCacheStockData("TopYearComicMan");
    }
