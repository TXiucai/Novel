...
import com.heiheilianzai.app.adapter.CouponAcceptAdapter;
...
public class CouponAcceptFragment extends BaseButterKnifeFragment {
    ...
    private List<CouponAcceptBean.ListBean> mAcceptLists = new ArrayList<>();
    private CouponAcceptAdapter mAcceptAdapter;
    ...
    protected void initView() {
        ...
        mAcceptAdapter = new CouponAcceptAdapter(getActivity(), mAcceptLists);
        mRyCoupon.setAdapter(mAcceptAdapter);
    ...
    private void getAcceptRecord() {
        ...
        HttpUtils.getInstance(activity).sendRequestRequestParams3(ReaderConfig.getBaseUrl() + ReaderConfig.COUPON_ACCEPT, json, true, new HttpUtils.ResponseListener() {
                    @Override
