...
public class DialogVip {
    ...
    public Dialog getDialogVipPop(Activity activity, String tittle, Boolean isExit) {
        return getDialogVipPop(activity, tittle, isExit, true);
    }

    public Dialog getDialogVipPop(Activity activity, String tittle, Boolean isExit, Boolean isExitYes) {
        ...
        vipHolder.dialog_tittle.setText(tittle);
