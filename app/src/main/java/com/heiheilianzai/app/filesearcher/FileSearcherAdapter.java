package com.heiheilianzai.app.filesearcher;
...
import com.heiheilianzai.app.filesearcher.searchengine.FileItem;
import com.heiheilianzai.app.filesearcher.searchengine.SearchEngine;
...
public class FileSearcherAdapter extends RecyclerView.Adapter<FileSearcherAdapter.FileSearcherVH> {
    ...
    public FileSearcherAdapter(Context context,@NonNull SearchEngine searchEngine){
        colorUnchecked = context.getResources().getColor(com.heiheilianzai.app.R.color.fileSearcherWhite);
        colorChecked = context.getResources().getColor(com.heiheilianzai.app.R.color.fileSearcherCheckedBackground);
        this.searchEngine = searchEngine;
    }

    @Override
    public FileSearcherVH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FileSearcherVH(LayoutInflater.from(parent.getContext()).inflate(com.heiheilianzai.app.R.layout.file_searcher_item,parent,false));
    }
    ...
    class FileSearcherVH extends RecyclerView.ViewHolder{
        ...
        public FileSearcherVH(final View itemView) {
            super(itemView);
            title = itemView.findViewById(com.heiheilianzai.app.R.id.file_searcher_item_text_title);
            detail = itemView.findViewById(com.heiheilianzai.app.R.id.file_searcher_item_text_detail);
            path = itemView.findViewById(com.heiheilianzai.app.R.id.file_searcher_item_text_path);
            checkBox = itemView.findViewById(com.heiheilianzai.app.R.id.file_searcher_item_check_box);
