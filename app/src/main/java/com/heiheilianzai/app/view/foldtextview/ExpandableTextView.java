package com.heiheilianzai.app.view.foldtextview;
...
//                    }
     ...
     * @param drawableId
     */
    public void setOpenSuffixImage(@DrawableRes int drawableId) {
        updateOpenSuffixSpan(drawableId);
    }
     ...
     * @param drawableId
     */
    public void setCloseSuffixImage(@DrawableRes int drawableId) {
        updateCloseSuffixSpan(drawableId);
    }
     ...
     * 更新展开后缀Spannable
     */
    private void updateOpenSuffixSpan(@DrawableRes int drawableId) {
        if (TextUtils.isEmpty(mOpenSuffixStr)) {
            mOpenSuffixSpan = null;
            return;
        }
        ...
        int iconwidth = dp2px(getContext(), 28);//27
        int iconHeight = dp2px(getContext(), 18);//15
        drawable.setBounds(0, 0, iconwidth, iconHeight);
        ImageSpan imageSpan = new ImageSpan(drawable, ImageSpan.ALIGN_BASELINE);
        mOpenSuffixSpan.setSpan(imageSpan, 0, mOpenSuffixStr.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
     ...
     * 更新收起后缀Spannable
     */
    private void updateCloseSuffixSpan(@DrawableRes int drawableId) {
        if (TextUtils.isEmpty(mCloseSuffixStr)) {
            mCloseSuffixSpan = null;
            return;
        }
        ...
        mCloseSuffixSpan.setSpan(imageSpan, 0, mCloseSuffixStr.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        if (mCloseInNewLine) {
            AlignmentSpan alignmentSpan = new AlignmentSpan.Standard(Layout.Alignment.ALIGN_OPPOSITE);
            mCloseSuffixSpan.setSpan(alignmentSpan, 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
