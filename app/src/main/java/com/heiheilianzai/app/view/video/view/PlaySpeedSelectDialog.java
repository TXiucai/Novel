...
public class PlaySpeedSelectDialog extends Dialog implements View.OnClickListener {
    private List<TextView> mTextViewList;
    private float mSpeed;
    private OnPlaySpeedSelectListener mListener;

    public PlaySpeedSelectDialog(@NonNull Context context, float speed ,OnPlaySpeedSelectListener listener) {
        super(context);
    ...
    private void switchSelect() {
        for (int i = 0; i < mTextViewList.size(); i++) {
            ...
            if (tag == mSpeed) {
                ...
                mTextViewList.get(i).setTextColor(getContext().getResources().getColor(R.color.color_1a1a1a));
            }
        }
    }

    public interface OnPlaySpeedSelectListener {
