package com.live.eggplant.player.utils;
...
public class OrientationUtils {
    ...
    public OrientationUtils(Activity activity, GSYBaseVideoPlayer gsyVideoPlayer) {
        ...
        this.gsyVideoPlayer = new WeakReference<>(gsyVideoPlayer).get();
        init();
    }

    private void init() { //http://10.64.36.133:8080/browse/QIEZ-740
        ...
        try {
            orientationEventListener = new OrientationEventListener(activity.getApplicationContext()) {
                ...
                public void onOrientationChanged(int rotation) {
                    ...
                    Log.i(OrientationUtils.class.getSimpleName(), rotation + "__");
                    ...
                    // if (((rotation >= 0) && (rotation <= 70)) || (rotation >= 330)) {
                    if (((rotation >= 0) && (rotation <= 15)) || (rotation >= 345)) {

                        Log.i(OrientationUtils.class.getSimpleName(), rotation + "__设置竖屏");
                        if (mClick) {
                    ...
                    // else if (((rotation >= 230) && (rotation <= 310))) {
                        ...
                        Log.i(OrientationUtils.class.getSimpleName(), rotation + "__设置横屏");
                        if (mClick) {
                    ...
                    // else if (rotation > 30 && rotation < 95) {
                        ...
                        Log.i(OrientationUtils.class.getSimpleName(), rotation + "__反向横屏");
                        if (mClick) {
            ...
            Log.i(OrientationUtils.class.getSimpleName(),e.getMessage());
    ...
    public void resolveByClick() {
        try {
            ...
            Log.e(OrientationUtils.class.getSimpleName(), e.getMessage());
        }
    }
