...
import com.live.eggplant.player.view.SmallVideoTouch;
import com.transitionseverywhere.TransitionManager;

import java.lang.reflect.Constructor;

import static com.live.eggplant.player.utils.CommonUtil.getActionBarHeight;
import static com.live.eggplant.player.utils.CommonUtil.getStatusBarHeight;
import static com.live.eggplant.player.utils.CommonUtil.hideNavKey;
import static com.live.eggplant.player.utils.CommonUtil.hideSupportActionBar;
import static com.live.eggplant.player.utils.CommonUtil.showNavKey;
import static com.live.eggplant.player.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e(GSYBaseVideoPlayer.class.getSimpleName(),e.getMessage());
                }
            }
        }, delay);
    ...
    public GSYVideoPlayer getFullWindowPlayer() {
        ...
        if (activity != null){
            ViewGroup vp = activity.findViewById(Window.ID_ANDROID_CONTENT);
