package com.live.eggplant.player.video;
...
import com.live.eggplant.player.ENDownloadView;
import com.live.eggplant.player.ENPlayView;
...
import com.live.eggplant.player.utils.NetworkUtils;
...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
     ...
     */
    @Override
    protected void setGoBackViewShowState(int visibility) {
    ...
    protected void changeUiToError() {
        ...
        setViewShowState(mTopContainer, VISIBLE);
	   //TODO setViewShowState(mTopContainer, INVISIBLE);
        setViewShowState(mBottomContainer, INVISIBLE);
        setViewShowState(mStartButton, VISIBLE);
        setViewShowState(mLoadingProgressBar, INVISIBLE);
        setViewShowState(mThumbImageViewLayout, INVISIBLE);
